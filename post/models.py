...
def post_user_directory_path(instance, filename):
    return 'user_{0}/{1}'.format(instance.post.user.id, filename)
...
class Post(models.Model):
    ...
    picture = models.ImageField(upload_to=user_directory_path, verbose_name="Picture", null=True, blank=True)  # comment
...
class PostImage(models.Model):
    post = models.ForeignKey(Post, on_delete=models.CASCADE, related_name='post_images') #1 1
    image = models.ImageField(upload_to=post_user_directory_path) # football.jpg   kite.jpg
